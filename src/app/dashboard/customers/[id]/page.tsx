    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between gap-3">
        <div>
          ...
          <p className="text-sm text-gray-500">Müşteri detayı ve bağlı makineler</p>
        </div>
        ...
        <div className="flex items-center gap-2">
          ...
          <details className="relative">
            ...
            <div className="absolute right-0 z-20 mt-2 w-[520px] max-w-[90vw] rounded-xl border bg-white p-5 shadow-xl">
              <h2 className="mb-4 text-lg font-semibold">Bu Müşteriye Yeni Makine Ekle</h2>
      ...
      <div className="grid gap-6">
        <div className="rounded-xl border bg-white p-5">
          ...
          <div className="grid gap-4 text-sm md:grid-cols-2">
            <div>
              <div className="text-gray-500">İlgili Kişi</div>
            ...
            <div>
              <div className="text-gray-500">Konum</div>
            ...
            <div>
              <div className="text-gray-500">Vergi Dairesi</div>
              <div className="font-medium">{customer.tax_office || "-"}</div>
            </div>

            <div>
              <div className="text-gray-500">Vergi No</div>
        ...
        <div className="rounded-xl border bg-white p-5">
          <div className="mb-4 flex items-center justify-between">
            <h2 className="text-lg font-semibold">Bağlı Makineler</h2>
            <span className="text-sm text-gray-500">{(machines ?? []).length} adet</span>
          </div>

          {(machines ?? []).length === 0 ? (
            <div className="text-sm text-gray-500">Bu müşteriye bağlı makine yok.</div>
          ) : (
