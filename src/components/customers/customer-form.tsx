...
export default function CustomerForm({
  ...
  const formContent = (
    <form onSubmit={handleSubmit} className="space-y-5">
      ...
      {errorText ? (
        <div className="rounded-lg border border-red-200 bg-red-50 px-3 py-2 text-sm text-red-700 dark:border-red-900/30 dark:bg-red-950/30 dark:text-red-400">
          {errorText}
        </div>
      ) : null}
      ...
      <div className="flex flex-wrap items-center justify-end gap-3">
        ...
        <button
          ...
          className="rounded-lg bg-black px-4 py-2 text-sm font-medium text-white transition hover:bg-slate-800 disabled:opacity-60 dark:bg-slate-100 dark:text-slate-900 dark:hover:bg-slate-200"
        >
