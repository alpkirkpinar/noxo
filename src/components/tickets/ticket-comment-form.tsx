...
export default function TicketCommentForm({
  ...
  return (
    <div className="rounded-xl border border-slate-200 bg-white p-5">
      <h2 className="mb-4 text-lg font-semibold text-slate-900">Yorum Ekle</h2>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <textarea
          ...
          className="min-h-[120px] w-full rounded-lg border border-slate-200 bg-white px-3 py-2 text-sm text-slate-900 focus:border-blue-500 focus:outline-none"
        />
